"""
Tableau des performances DuckDB (lecture de benchmark_results.csv).

Usage : python plot_benchmark_duckdb.py
Sortie : performances_duckdb.png
"""
...
OUT = HERE / "performances_duckdb.png"


def main() -> None:
    df = pd.read_csv(CSV)

    col_labels = ["Requête", "Min (µs)", "Moyenne (µs)", "Max (µs)", "Lignes"]
    cell_text = []
